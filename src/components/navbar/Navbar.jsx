      ...
      <nav className="flex justify-between md:mx-2 flex-wrap-reverse">
        ...
        <div className="text-[#ffffff]" id="menu">
          <ul
            className={
              hamburger
                ? "fixed left-0 bg-black z-30 text-white w-full h-full md:text-left text-center"
                : "list-none absolute md:static md:flex -left-full"
            }
          >
                  ...
                  {isAuthenticated ? (
                    ...
                    <>
                      <div
                        ...
                        className="inline-block w-10 h-10 mt-[-0.5rem] mx-3 border-[1px] border-[#663581] rounded-full cursor-pointer"
                        ref={menuRef}
                      >
                      ...
                      <div
                        className={
                          isOpen
                            ? "absolute right-[-2rem] w-48 top-11"
                            : "hidden"
                        }
                      >
                        <ul className="floatMenu bg-[#8d48b3] rounded text-sm text-center text-[#ffffff] p-2">
                          <li>
